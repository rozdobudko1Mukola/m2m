...
def test_list_of_objects_by_stop_m2m_773(authenticated_page: Page, grafic=0):
    analytics_page = AnalyticsPage(authenticated_page)
...
def test_change_objects_in_diagram_by_stop_time_m2m_1597(authenticated_page: Page):
    pass


# M2M-774 Create a custom list of objects by mileage
def test_list_of_objects_by_mileage_m2m_774(authenticated_page, grafic=1):
    analytics_page = AnalyticsPage(authenticated_page)
    expected_result = analytics_page.add_device_to_diagram(grafic)
    authenticated_page.wait_for_timeout(1000)
    actual_result = analytics_page.get_device_from_diagram()
...
def test_change_objects_in_diagram_by_max_speed_m2m_1599(authenticated_page: Page):
    pass
