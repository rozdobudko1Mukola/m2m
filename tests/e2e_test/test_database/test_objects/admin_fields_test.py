...
@pytest.fixture()
def revove_admin_filds(api_context: APIRequestContext, token: str, test_data):
...
class TestCustomFields:
    ...
    def test_open_custom_fields_tab(self, user_page, full_unit_create_and_remove_by_api, revove_admin_filds):
        ...
        expect(custom_fields_page.save_btn).to_be_disabled()  # Check the save button is disabled
    ...
    @pytest.mark.parametrize("user_page", ["SELFREG"], indirect=True)
    @pytest.mark.parametrize("full_unit_create_and_remove_by_api", [1], indirect=True)
    def test_fill_custom_fields_tab(self, user_page, full_unit_create_and_remove_by_api, revove_admin_filds):
        objects_page = ObjectsPage(user_page)
        custom_fields_page = CustomAdminFieldsPage(user_page)
        ...
        expect(custom_fields_page.get_field("name", 0)).to_be_disabled()  # Check the first name field is disabled
        expect(custom_fields_page.get_field("value", 0)).to_be_enabled()  # Check the first value field is enabled
        expect(custom_fields_page.save_btn).to_be_disabled()  # Check the save button is disabled
        expect(custom_fields_page.del_btn.nth(0)).to_be_enabled()  # Check the delete button is enabled
    ...
    @pytest.mark.parametrize("user_page", ["SELFREG"], indirect=True)
    @pytest.mark.parametrize("full_unit_create_and_remove_by_api", [1], indirect=True)
    def test_fill_custom_fields_tab_max(self, user_page, full_unit_create_and_remove_by_api, revove_admin_filds):
    ...
    def test_remove_custom_fields(self, user_page, full_unit_create_and_remove_by_api):
        ...
        expect(custom_fields_page.empty_fields.nth(0)).to_be_enabled()  # Check the first empty name field is enabled
        expect(custom_fields_page.empty_fields.nth(1)).to_be_enabled()
        expect(custom_fields_page.save_btn).to_be_disabled()  # Check the save button is disabled
        expect(custom_fields_page.del_btn).not_to_be_visible()  # Check the delete button is not visible
    ...
    def test_check_modal_window(self, user_page, full_unit_create_and_remove_by_api, revove_admin_filds):
        ...
        expect(custom_fields_page.modal_window["modal_title"]).to_be_visible()  # Check the modal window is visible
    ...
    def test_fill_custom_fields_tab_invalid_length(
        ...
        expect(custom_fields_page.error["input_border"].nth(0)).to_have_css("border-color", self.err_color_msg)
        expect(custom_fields_page.error["input_border"].nth(1)).to_have_css("border-color", self.err_color_msg)
    ...
    @pytest.mark.parametrize("user_page", ["SELFREG"], indirect=True)
    @pytest.mark.parametrize("full_unit_create_and_remove_by_api", [1], indirect=True)
    def test_add_multiple_custom_fields(self, user_page, full_unit_create_and_remove_by_api, revove_admin_filds):
        ...
        expect(custom_fields_page.error["form_err_msg"]).to_be_visible()  # Check the error message is displayed
